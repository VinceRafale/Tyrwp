...
function foundation5_s_setup() {
	 ...
	 * to change 'foundation5_s' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'foundation5_s', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'foundation5_s' ),
	) );

	// Custom Fallback for when wp_nav_menu() is not set
	function default_menu() {
		echo '<h3><a href="/wp-admin/nav-menus.php">' . __( 'Please Setup your Menus', 'foundation5_s' ) . '</a></h3>';
	}
...
function foundation5_s_scripts() {
  ...
  wp_enqueue_style( 'foundation-style' );
	...
	wp_register_script('foundation-jquery',get_template_directory_uri() . '/bower_components/jquery/jquery.js', array(), null, true );
  wp_register_script('foundation-main', get_template_directory_uri() . '/bower_components/foundation/js/foundation.js', array(), null, true );
  wp_register_script('foundation-app', get_template_directory_uri() . '/js/app.js', array(), null, true );
  wp_enqueue_script( 'foundation-mod' );
  wp_enqueue_script( 'foundation-jquery' );
  wp_enqueue_script( 'foundation-main' );
  wp_enqueue_script( 'foundation-app' );
	wp_enqueue_script( 'foundation5_s-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
	wp_enqueue_script( 'foundation5_s-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
